                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <a id="sample_editable_1_new" href="{{route('gym-admin.superadmin.branch')}}" class="btn sbold dark"> Add Novo
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column table-100" id="manage-branches">
                                <thead>
                                <tr>
                                    <th class="max-desktop"> Branch Nome </th>
...
<script>
    ...
    table.dataTable({
        ...
        "language": {
            ...
            "search": "Pesquisar:",
            "processing": "<i class='fa fa-spinner faa-spin animated'></i> Processando",
    ...
    function deleteModal(id) {
        ...
        $('#modelHeading').html('Remover Branch');
